...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/asheeka/SSHVPS/main/"
...
echo -e " \e[1;32m2)\e[0m Menggunakan Domain Sistem"
echo -e " ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
TIMES="10"
CHATID="5951220980"
KEY="6745920426:AAH8Z5ibFGHv8nXbaIRFiTg7-LBSAa6YK3k"
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://wa.me/+62895416464300"}]]}' 
...
wget -q https://raw.githubusercontent.com/asheeka/SSHVPS/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
...
port 587
auth on
user gunakansaja@gmail.com
from gunakansaja@gmail.com
password kk112234 
logfile ~/.msmtp.log
EOF
